...
${content(node, context)}`.trim();
  ...
  function containerComponent(node, _, context) {
    ...
    if ((value + attributesText).length > ((opts == null ? void 0 : opts.maxAttributesLength) || 80) || Object.keys(node.fmAttributes).length > 0 || ((_a = node.children) == null ? void 0 : _a.some((child) => child.type === "componentContainerSection"))) {
